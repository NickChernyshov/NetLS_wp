 ...
 * @return string|null String when retrieving, null when displaying.
 */
function get_calendar($initial = true, $echo = true, $monthnum, $year ) {
	...
	foreach ( $myweek as $wd ) {
		...
		$wd = esc_attr($wd);
		$calendar_output .= "\n\t\t<th bgcolor=lightblue scope=\"col\" title=\"$wd\">$day_name</th>";
	}
...
<!--        It is part with reference to the prev or next mounth
	<tfoot>
	<tr>';
